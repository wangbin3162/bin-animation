...
// 注册动画
animations.registerAnimation = function (opts) {
 ...
 * @param callback 回调函数
 */
animations.runAnimation = function (els, opts, callback = function () {
}) {
  ...
  opts = Object.assign(opts, found.presets, mainDefaults)
...
// 取消动画
animations.unregisterAnimation = function (name) {
